<x-base-layout>
    ...
    <div class="content d-flex flex-column flex-column-fluid" id="kt_content">
        ...
        <div class="post d-flex flex-column-fluid" id="kt_post">
            ...
            <div id="kt_content_container" class="container-xxl">
                <!--begin::Card-->
                <h4>عرض جميع المستخدمين في النظام + اضافة مستخدم جديد</h4>
                        ...
                        <div class="card-title">
                            ...
                            <div class="d-flex align-items-center position-relative my-1">
                                ...
                                <input type="text" data-kt-user-table-filter="search"
                                    class="form-control form-control-solid w-250px ps-14" placeholder="بحث مستخدم" />
                            </div>
                            <!--end::Search-->
                        </div>
                        <!--begin::Card title-->
                        ...
                        <div class="card-toolbar">
                            ...
                            <div class="d-flex justify-content-end" data-kt-user-table-toolbar="base">
                                ...
                                <button type="button" class="btn btn-primary" data-bs-toggle="modal"
                                    ...
                                    <!--end::Svg Icon-->إضافة مستخدم جديد
                                </button>
                                <!--end::Add user-->
                            </div>
                            <!--end::Toolbar-->
                                        ...
                                        <div class="modal-body scroll-y mx-5 mx-xl-15 my-7">
                                            ...
                                            <form id="kt_modal_export_users_form" class="form" action="#">
                                                ...
                                                <div class="fv-row mb-10">
                                                    <!--begin::Label-->
                                                    <label class="fs-6 fw-bold form-label mb-2"> يجب اضافة نوع الحساب
                                                        هنا : مستفيد أو داعم أو اداري</label>
                                                    <!--end::Label-->
                                                    <!--begin::Input-->
                                                    <select name="role" data-control="select2"
                                                        ...
                                                        <option></option>
                                                        <option value="Administrator">إداري</option>
                                                        <option value="Analyst">مستفيد</option>
                                                        <option value="Developer">داعم</option>
                                ...
                                <div class="modal-dialog modal-dialog-centered mw-650px">
                                    ...
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-header" id="kt_modal_add_user_header">
                                            <!--begin::Modal title-->
                                            <h2 class="fw-bolder">إضافة مستخدم جديد</h2>
                                            <!--end::Modal title-->
                                            <!--begin::Close-->
                                            <div class="btn btn-icon btn-sm btn-active-icon-primary"
                                                data-kt-users-modal-action="close">
                        ...
                        <table class="table align-middle table-row-dashed fs-6 gy-5" id="kt_table_users">
                            ...
                            <thead>
                                ...
                                <tr class="text-start text-muted fw-bolder fs-7 text-uppercase gs-0">
                                    ...
                                    <th class="min-w-125px">عضو متطوع؟</th>
                                    <th class="min-w-125px">تاريخ الانضمام</th>
                                    <th class="text-end min-w-100px">خيارات</th>
                                </tr>
                                <!--end::Table row-->
                            </thead>
                            <!--end::Table head-->
                                    ...
                                    <tr>
                                        ...
                                        <td class="d-flex align-items-center">
                                            ...
                                            <div class="symbol symbol-circle symbol-50px overflow-hidden me-3">
                                                <a href="../../alkhirat/dist/apps/user-management/users/view.html">
                                                    <div class="symbol-label">
                                                        <img src="{{ asset('alkhirat/media/avatars/300-6.jpg') }}"
                                            ...
                                            <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-bold fs-7 w-125px py-4"
                                                ...
                                                <div class="menu-item px-3">
                                                    <a href="#" class="menu-link px-3"
                                                        data-kt-users-table-filter="delete_row">ارسال رسالة</a>
                                                </div>
                                                <!--end::Menu item-->
                                            </div>
                                            <!--end::Menu-->
    ...
    <script defer src="assets/plugins/global/plugins.bundle.js"></script>
    <script defer src="assets/js/scripts.bundle.js"></script>
    <!--end::Global Javascript Bundle-->
    <!--begin::Page Vendors Javascript(used by this page)-->
    <script defer src="assets/plugins/custom/datatables/datatables.bundle.js"></script>
    <!--end::Page Vendors Javascript-->
    <!--begin::Page Custom Javascript(used by this page)-->
    <script defer src="assets/js/custom/apps/user-management/users/list/table.js"></script>
    <script defer src="assets/js/custom/apps/user-management/users/list/export-users.js"></script>
    <script defer src="assets/js/custom/apps/user-management/users/list/add.js"></script>
    <script defer src="assets/js/widgets.bundle.js"></script>
    <script defer src="assets/js/custom/widgets.js"></script>
    <script defer src="assets/js/custom/apps/chat/chat.js"></script>
    <script defer src="assets/js/custom/utilities/modals/users-search.js"></script>
